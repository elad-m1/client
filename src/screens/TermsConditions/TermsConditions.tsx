...
import {Text as RNText, Text, View} from "react-native";
...
const TermsConditions = () => {
  ...
  return (
    <View style={styles.mainWrapper}>
      <SimpleHeader title={t("terms_conditions.header")} />
      <ScrollView contentContainerStyle={{paddingBottom: bottom}}>
        <RNText style={styles.text}>
          ...
          versions of Lorem Ipsum. The standard chunk of Lorem Ipsum used since
